...
- (void)initWithData:(NSArray*)lstPhoto
{
	...
	for (int i = 0; i < [lstPhoto count]; i++)
	{
		...
		[imvPhoto setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@",WEBAPI_URL,[[lstPhoto objectAtIndex:i] objectForKey:@"photo"]]]];
