...
@interface YYYGroupMemberViewController ()

@end

@implementation YYYGroupMemberViewController

@synthesize delegate;
@synthesize lstMember;
...
{
	[delegate DidMemberUpdated:lstMember];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSDictionary *dict = [lstMember objectAtIndex:indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	[[YYYCommunication sharedManager] LoadUserProfile:[[lstMember objectAtIndex:indexPath.row] objectForKey:@"user_id"]
											successed:successed
											  failure:failure];
}
