...
@interface YYYGroupMessageViewController : UIViewController<UIBubbleTableViewDataSource,NSBubbleDataDelegate,UITextFieldDelegate,UIScrollViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,AVAudioRecorderDelegate,UIActionSheetDelegate,HPGrowingTextViewDelegate>
{
...
@property (nonatomic, retain) NSMutableArray *lstMembers;
