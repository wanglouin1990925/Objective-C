...
@synthesize rightPanGesture;
@synthesize leftPanGesture;
...
//	[self setBackgroundColor:[UIColor grayColor]];
    ...
    self.leftHandle.center = CGPointMake(leftXCoor + 4, self.sliderBackground.center.y + 4);
	
//	[self.leftHandle setBackgroundColor:[UIColor colorWithRed:255.0f green:0 blue:0 alpha:.3f]];
    ...
    self.rightHandle.center = CGPointMake(rightXCoor - 4, self.sliderBackground.center.y + 4);
    
//	[self.rightHandle setBackgroundColor:[UIColor colorWithRed:255.0f green:0 blue:0 alpha:.3f]];
...
- (void)setupUI {
    ...
    self.leftHandle.contentMode = UIViewContentModeRight;
    self.leftHandle.userInteractionEnabled = YES;
    
    leftPanGesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(leftHandlePanEngadged:)];
    ...
    self.rightHandle.contentMode = UIViewContentModeLeft;
    self.rightHandle.userInteractionEnabled = YES;
        
    rightPanGesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(rightHandlePanEngadged:)];
