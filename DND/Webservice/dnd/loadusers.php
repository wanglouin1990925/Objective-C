<?php
	...
	$query 	= "select * from  tbl_user as t1 join (select distinct(rat_userfbidto) as rat_userfbidto from tbl_rate where rat_userfbidto != '".$userfbid."' order by rat_date DESC limit 100) as t2 on t2.rat_userfbidto = t1.user_facebookid";
